...
public enum BotMessageEnum {
    ...
    PROJECT_CREATE_START_MESSAGE("Вы можете создать несколько проектов и подключить в них разные аккаунты"),
    PROJECT_CREATE_DONE_MESSAGE("Проект успешно создан"),
    PROJECT_NAME_ASK_MESSAGE("Введите название проекта, не более 30 символов"),
