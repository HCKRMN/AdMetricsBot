...
public enum MessageEnum {
    ...
    ADD_BITRIX_STEP_1_MESSAGE("""
            Перед тем как указать домен, убедитесь, что в вашем портале Битрикс24 установлено приложение AdMetricsBot в маркете! \s \s
    ...
    NOT_DELETE_USER_DATA_MESSAGE("Я рад что вы продолжаете пользоваться моим ботом!"),
