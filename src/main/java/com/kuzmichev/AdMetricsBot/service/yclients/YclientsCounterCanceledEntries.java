...
//public class YclientsCounterCanceledEntries {
...
//
//    @SneakyThrows
//    public int yclientsCounterCanceledEntries(String salonId){
//
...
//        }
//        log.error("Ошибка при получении количества отмененных записей̆ Yclients в салоне {} : {}", salonId, responseBody);
//        return -1;
//    }
//}