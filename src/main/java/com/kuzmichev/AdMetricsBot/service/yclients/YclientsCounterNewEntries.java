...
public class YclientsCounterNewEntries {
    ...
    @SneakyThrows
    public int yclientsCounterNewEntries(String salonId){
        ...
        String endDate = now.plusYears(1).format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
