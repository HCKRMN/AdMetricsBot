...
public class DisableNotificationsCallbackHandler implements CallbackHandler {
    NotificationController notificationController;
    SettingsKeyboard settingsKeyboard;

    @Override
    public boolean canHandle(String data) {
        return data.equals(CallBackEnum.DISABLE_NOTIFICATIONS_CALLBACK.getCallBackName());
    }
